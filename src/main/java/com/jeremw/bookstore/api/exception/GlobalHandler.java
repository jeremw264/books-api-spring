package com.jeremw.bookstore.api.exception;
...
public class GlobalHandler extends ResponseEntityExceptionHandler {
	...
	/**
	 * Handles access denied errors within the application.
	 *
	 * @param req       The HttpServletRequest in which the access was denied.
	 * @param exception The AccessDeniedException that was thrown.
	 * @return A ResponseEntity containing details of the access denied error.
	 */
	@ExceptionHandler(AccessDeniedException.class)
	public ResponseEntity<ResourceExceptionDTO> errorAccessDenied(HttpServletRequest req,
			AccessDeniedException exception) {

		log.error("Access denied error occurred. Request URL: {}", req.getRequestURL().toString(), exception);
